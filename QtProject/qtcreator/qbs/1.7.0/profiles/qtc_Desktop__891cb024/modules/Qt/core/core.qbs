...
Module {
    ...
    property string libFilePathRelease: "/opt/Qt5.7.1/5.7/gcc_64/lib/libQt5Core.so.5.7.1"
    ...
    cpp.includePaths: {
        var paths = ["/opt/Qt5.7.1/5.7/gcc_64/include", "/opt/Qt5.7.1/5.7/gcc_64/include/QtCore"];
